...
# Generated from cn.lightfish.account.AccountService
module MicroserviceLightfishUserAccount
  ...
  class AccountService
    # @private
    # @param j_del [::MicroserviceLightfishUserAccount::AccountService] the java delegate
    def initialize(j_del)
      @j_del = j_del
    end
    # @private
    # @return [::MicroserviceLightfishUserAccount::AccountService] the underlying java delegate
    def j_del
      @j_del
    end
    ...
    def add_account(account=nil)
      if account.class == Hash && block_given?
        @j_del.java_method(:addAccount, [Java::CnLightfishAccount::Account.java_class,Java::IoVertxCore::Handler.java_class]).call(Java::CnLightfishAccount::Account.new(::Vertx::Util::Utils.to_json_object(account)),(Proc.new { |ar| yield(ar.failed ? ar.cause : nil) }))
        return self
      end
    ...
    def update_account(account=nil)
      if account.class == Hash && block_given?
        @j_del.java_method(:updateAccount, [Java::CnLightfishAccount::Account.java_class,Java::IoVertxCore::Handler.java_class]).call(Java::CnLightfishAccount::Account.new(::Vertx::Util::Utils.to_json_object(account)),(Proc.new { |ar| yield(ar.failed ? ar.cause : nil, ar.succeeded ? ar.result != nil ? JSON.parse(ar.result.toJson.encode) : nil : nil) }))
        return self
      end
